...
- **Multi-Player Support**: Detects playback in MPV, MPC-HC, VLC, and even Browser window titles on Windows.
...
- **Web UI**: Modern browser-based interface to manage your watch list and track progress.
- **Cross-Platform**: Full support for both Windows and macOS with native UI elements.
...
- `src/watchers/`: Contains specific playback watchers for different players (MPV, VLC, etc).
...
2. **Convert Icons**: `python build/convert_icon.py`
3. **Run Build**: `python package.py`
