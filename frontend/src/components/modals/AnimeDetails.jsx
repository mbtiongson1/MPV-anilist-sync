...
import { userSettings, animeList, localAnimeMap, recordApiRequest, showToast, pendingApiRequests } from '../../store';
...
export function AnimeDetailsModal({ anime, visible, onClose }) {
    ...
    const handleSave = async () => {
        const localAnime = localAnimeMap.value.get(anime.mediaId);
