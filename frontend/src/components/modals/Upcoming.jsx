...
export function UpcomingOverlay({ visible, onClose }) {
    ...
    // O(1) lookup map for local list entries to avoid O(N*M) lookups in render loop
            ...
            <div class="upcoming-window">
                <div class="upcoming-header">
                    ...
                    <div style="display: flex; gap: 0.5rem; align-items: center;">
                        ...
                        <button class="refresh-btn" onClick={() => fetchData(true)} title="Refresh" aria-label="Refresh upcoming anime">
                ...
                <div id="upcoming-grid" class="upcoming-grid">
                    ...
                    {data.map(anime => {
                        ...
                        const localEntry = localAnimeMap.get(mediaId);
                        ...
                        return (
                            <div key={mediaId} class="upcoming-tile">
                                ...
                                <div class="upcoming-add-wrapper">
                                    <button class="btn-upcoming-add" aria-label="Add to list" title="Add to list" onClick={(e) => {
                                        e.stopPropagation();
