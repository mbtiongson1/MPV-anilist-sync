            ...
            <div class="header-right">
                <div class="theme-switch-wrapper" title="Dark/Light Mode" style={{ marginRight: '1.5rem' }}>
                    ...
                    <label class="theme-switch" for="theme-toggle">
                        <input type="checkbox" id="theme-toggle" aria-label="Toggle Dark/Light Mode" checked={theme === 'light'} onChange={toggleTheme} onKeyDown={e => { if(e.key === 'Enter') { e.preventDefault(); toggleTheme(); } }} />
                        <div class="slider">
                            <div class="moon-icon">
