            ...
            <div class="torrents-filter-bar" id="torrents-filter-bar">
                ...
                <div class="filter-group filter-toggle-group">
                    ...
                    <label class="toggle-switch" title="Scan only currently airing anime" for="tf-airing-only">
                        <input type="checkbox" id="tf-airing-only" checked={airingOnly} onChange={e => setAiringOnly(e.target.checked)} onKeyDown={e => e.key === 'Enter' && setAiringOnly(!airingOnly)} />
                ...
                <div class="filter-group filter-toggle-group">
                    ...
                    <label class="toggle-switch" title="Keep archived torrent candidates visible" for="tf-show-archived">
                        <input type="checkbox" id="tf-show-archived" checked={showArchived} onChange={e => setShowArchived(e.target.checked)} onKeyDown={e => e.key === 'Enter' && setShowArchived(!showArchived)} />
                        <span class="toggle-slider" />
                    </label>
                </div>
            </div>
