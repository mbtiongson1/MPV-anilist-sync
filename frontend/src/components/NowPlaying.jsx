...
import { formatPopularity, getCachedImageUrl } from '../utils';
...
export function NowPlaying({ onOpenDetails }) {
    ...
    return (
        <div id="now-playing" class="now-playing now-playing-card">
                ...
                <div class="np-details">
                            ...
                            <select id="np-season" class="np-season-select" onChange={handleSeasonChange}>
                                {seasonOptions.sort((a, b) => (b.seasonYear || 0) - (a.seasonYear || 0)).map(opt => (
                                    <option key={opt.mediaId} value={opt.mediaId} selected={opt.mediaId === selectedMediaId}>
                                        {opt.title || `Season ${opt.season || ''} ${opt.seasonYear || ''}`}
                                    </option>
                                ))}
                            </select>
                        </div>
                    ...
                    <div class="np-controls">
                        ...
                        <div class="np-action-controls">
                            ...
                            <button id="btn-edit-nowplaying" class="icon-btn" onClick={handleOpenDetails} title="Edit" disabled={!selectedMediaId}>
...
function IdleState({ status }) {
    ...
    return (
        <div id="idle-state" class="idle-state idle-card">
            <div class="idle-icon">
