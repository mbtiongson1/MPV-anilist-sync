...
import { selectedAnime, clearSelection, pendingApiRequests, showToast, recordApiRequest, animeList, animeListMap } from '../store';
...
export function SelectionBar({ onShowReview }) {
    ...
    const moveSelectedTo = (newStatus) => {
        ...
        selectedIds.forEach(mediaId => {
            const anime = animeListMap.value.get(mediaId);
