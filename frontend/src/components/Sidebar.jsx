    ...
    return (
        <nav id="app-sidebar" class={collapsed ? 'collapsed' : ''}>
            <div class="sidebar-header">
                <button class="sidebar-toggle" id="sidebar-toggle" title="Toggle Sidebar" aria-label="Toggle Sidebar" onClick={toggleSidebar}>
            ...
            <div class="sidebar-content">
                ...
                <div class="sidebar-section">
                    <div class="sidebar-section-title" style="display: flex; justify-content: space-between; align-items: center;">
                        <span>Filters</span>
                        <button id="btn-reset-filters" class="icon-btn reset-filters-btn" title="Reset Filters to Default" aria-label="Reset Filters to Default" onClick={resetFilters}>
                    ...
                    <div class="sidebar-filters">
                        ...
                        <div class="filter-group-sidebar">
                            <div style="display: flex; justify-content: space-between; align-items: center;">
                                ...
                                <button id="sidebar-airing-only" class={`airing-only-btn ${airingOnly ? 'active' : ''}`} aria-pressed={airingOnly} onClick={handleAiringOnlyToggle} title="Filter by current season and year" aria-label="Airing Only">
                                ...
                                {seasons.map(season => {
                                    ...
                                    return (
                                        <div key={season} class="season-pill-wrapper">
                                            <button class={`season-pill ${season.toLowerCase()} ${isActive ? 'active' : ''}`} aria-pressed={isActive} data-season={season} onClick={() => toggleSeason(season)}>
